...
int main(int argc, char *argv[])
{
    ...
    //identificar
    printf("%s\n", "Exemplo0212 - Programa = v2.2"); // identificar programa
    ...
    //ler do teclado
    printf("\nEntrar com um valor inteiro, para testar se e par ou impar, e menor ou maior que 100: "); //pedido para inserir o caractere
    ...
    {
        if (x > 100) //testar se o numero e maior que 100
        {
