/*
Guia0114 - v1.4. - 11/03/2021
Author: 724577 - Leo Soares

>> Comando: g++ -o Guia0114.exe Guia0114.cpp (para executar em uma janela de comandos no Windows)

Nome do arquivo: Guia0114
*/
...
void pick52 ( ) //pegar beeper na posicao 5,2
{
moveN (4);
turnLeft ( );
move( );
...
void pick26 ( ) //pegar beeper na posicao 2,6
{
moveN (3);
turnRight( );
moveN (4);
...
decorateWorld ( "Guia0114.txt" ); //decorar o mundo
