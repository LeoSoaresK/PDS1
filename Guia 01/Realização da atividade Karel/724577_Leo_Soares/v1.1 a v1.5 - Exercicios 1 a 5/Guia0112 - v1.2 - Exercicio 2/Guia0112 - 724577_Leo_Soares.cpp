/*
Guia0112 - v1.2. - 10/03/2021
Author: 724577 - Leo Soares

>> Comando: g++ -o Guia0112.exe Guia0112.cpp (para executar em uma janela de comandos no Windows)

Nome do arquivo: Guia0112
*/
...
void gohome ( ) //voltar para a posicao inicial
{
moveN(2);
turnLeft( );
moveN(2);
...
decorateWorld ( "Guia0112.txt" ); //decorar o mundo
