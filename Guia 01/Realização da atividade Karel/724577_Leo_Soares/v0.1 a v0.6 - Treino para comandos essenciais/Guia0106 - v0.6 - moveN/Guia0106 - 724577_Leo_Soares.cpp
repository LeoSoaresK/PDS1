...
@param steps (int steps) - numero de passos a serem dados.
*/
void moveN ( int steps )
{
if (steps > 0) //testar se a quantidade de steps e maior que 0
{
	move( ); //dar um passo
	moveN (steps - 1); // repetir o moveN, com menos um passo dessa vez
} // end if
} // end moveN( )
/**
