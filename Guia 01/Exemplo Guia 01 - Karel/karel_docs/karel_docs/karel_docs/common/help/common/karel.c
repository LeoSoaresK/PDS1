...
/**
   Check if there's any error code set.
...
/**
   Check if world slot ahead has free space for robot.
...
/**
   Check if world slot at left has free space for robot.
   @return true , if there is an free space;
           false, otherwise
 */
bool leftIsClear ( )
...
/**
   Check if world slot at right has free space for robot.
   @return true , if there is an free space;
           false, otherwise
 */
bool rightIsClear ( )
...
/**
   Check if current robot faces a given direction at world.
...
/**
   Check if current robot faces North.
   @return true , if robot is facing the desired direction;
           false, otherwise
 */
bool facingNorth ( )
...
/**
   Check if current robot faces South.
   @return true , if robot is facing the desired direction;
           false, otherwise
 */
bool facingSouth ( )
...
/**
   Check if current robot faces East.
   @return true , if robot is facing the desired direction;
           false, otherwise
 */
bool facingEast ( )
...
/**
   Check current robot faces West.
   @return true , if robot is facing the desired direction;
           false, otherwise
 */
bool facingWest ( )
